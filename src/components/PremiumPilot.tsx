import { premiumPilotProperties } from '../constans';
...
const PremiumPilot = () => {
    return (
        <div className="py-8 px-2 2xl:py-16 2xl:px-11 bg-[#2F343C] rounded-2xl border-[2px] border-transparent hover:border-lightgreen/50 max-w-[570px] w-full mx-auto transition-all duration-150">
            ...
            <p className="mt-4 text-[14px] xl:text-[16px] font-normal leading-[18.34px] xl:leading-[21px] text-center">
                Идеально подходит для команды, которая уже не первый день
                работает со схемами.
            </p>
            <ul className="my-8 flex flex-col gap-4 xl:mb-[64px]">
                {premiumPilotProperties.map((property) => (
